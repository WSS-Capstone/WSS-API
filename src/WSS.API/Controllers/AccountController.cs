...
public class AccountController : BaseController
{
    ...
    [HttpPatch]
    public async Task<IActionResult> UpdateAccountProfile([FromBody] UpdateAccountProfileCommand request, CancellationToken cancellationToken = default)
    {
    ...
    [HttpPatch("profile")]
    public async Task<IActionResult> UpdateAccountProfile([FromBody] UpdateMyAccountProfileCommand request, CancellationToken cancellationToken = default)
    {
        var email = this._identitySvc.GetEmail();
