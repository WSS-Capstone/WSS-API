...
public class GetCommissionsQuery : PagingParam<CommissionSortCriteria>, IRequest<PagingResponseQuery<CommissionResponse, CommissionSortCriteria>>
{
    ...
    PagingResponseQuery<CommissionResponse, CommissionSortCriteria>>
{
    ...
    public async Task<PagingResponseQuery<CommissionResponse, CommissionSortCriteria>> Handle(GetCommissionsQuery request, CancellationToken cancellationToken)
    {
        var query = _commissionRepo.GetCommissions();
