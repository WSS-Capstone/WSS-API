...
public class GetCombosQuery : PagingParam<ComboSortCriteria>, IRequest<PagingResponseQuery<ComboResponse, ComboSortCriteria>>
{
    ...
    GetCombosQueryHandler : IRequestHandler<GetCombosQuery, PagingResponseQuery<ComboResponse, ComboSortCriteria>>
{
    ...
    public async Task<PagingResponseQuery<ComboResponse, ComboSortCriteria>> Handle(GetCombosQuery request, CancellationToken cancellationToken)
    {
        var query = _comboRepo.GetCombos();
